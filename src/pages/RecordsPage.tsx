...
import { DateTime } from 'luxon';   // ✅ Luxon import
...
/* ✅ Luxon Kuwait formatter */
function formatKuwaitDate(date: string | Date) {
  return DateTime
    .fromISO(typeof date === 'string' ? date : date.toISOString(), { zone: 'utc' })
    .setZone('Asia/Kuwait')
        ...
        {filtered.length === 0 ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-16">
            ...
            <p className="text-slate-400 text-sm mt-1">
              {search ? 'Try a different ITS number' : 'Add your first entry to get started'}
            </p>
                ...
                >
                  ...
                  {latestVisit && (
                    <div className="mt-3 pt-3 border-t border-slate-50 flex items-center justify-between">
                      ...
                      <span className="text-xs text-slate-400">
                        Last visit: {formatKuwaitDate(latestVisit.date)}
                      </span>
